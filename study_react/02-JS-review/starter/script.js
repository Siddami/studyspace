...
//   title: book.title,
//   author: book.author,
//   reviewsCount: reviewsCount(book),
// }));
// essentialData;
...
// const demoArr = [4, 9, 10, 3, 4, 8]
// const sorted= demoArr.slice().sort((a,b)=> a-b)
// sorted
...
// const bookAfterDelete = booksAfterAdd.filter(books => books.id !== 3);
// bookAfterDelete
